...
function getOpenAIClient(): OpenAI {
  ...
  if (!apiKey) {
    throw new Error("OpenAI API key is not configured. Please set AI_INTEGRATIONS_OPENAI_API_KEY environment variable.");
  }
...
// Export for backward compatibility - will throw if API key is missing when accessed
