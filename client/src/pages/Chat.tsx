  ...
  return (
    ...
    >
      ...
      <header className="bg-primary/5 border-b p-3 sm:p-4 flex items-center gap-3">
        ...
        <div>
          <h1 id="chat-heading" className="font-bold text-base sm:text-lg font-display text-foreground">My Financial Mentor</h1>
        ...
        {!activeConversationId ? (
          <div className="flex flex-col items-center justify-center h-full gap-4 text-center">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">Click "New Chat" to start talking to My Financial Mentor.</p>
            </div>
            <button
              onClick={() => createConversation.mutate()}
              disabled={createConversation.isPending}
          ...
          <>
            ...
            >
              <div
                ...
                aria-label={msg.role === "user" ? "Your message" : "My Financial Mentor response"}
              >
                {msg.role === "assistant" && (
            ...
            {sendMessage.isPending && (
              <div className="flex justify-start" role="status" aria-live="polite" aria-label="My Financial Mentor is typing">
      ...
      <footer className="p-3 sm:p-4 bg-card border-t">
        <form onSubmit={handleSubmit} className="flex gap-2" aria-label="Send a message to My Financial Mentor">
          <div className="relative flex-1">
            <label htmlFor="chat-message-input" className="sr-only">
              Message to My Financial Mentor
            </label>
            <input
        ...
        <p id="chat-disclaimer" className="text-center text-xs text-muted-foreground mt-2">
          My Financial Mentor provides financial guidance, not professional advice.
        </p>
      </footer>
    </section>
  );
